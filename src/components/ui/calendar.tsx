  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        button_next: cn(
          buttonVariants({ variant: buttonVariant }),
          "size-(--cell-size) p-0 select-none aria-disabled:opacity-50 0",
        ...
        // bg-muted comitado decido ele ser responsável por formar o background da data atual 
        today: cn(
